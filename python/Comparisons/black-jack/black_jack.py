...
def is_blackjack(card_one, card_two):
    ...
    if (card_one is not "A") or (card_one in card_numbers):
        c1_val = value_of_card(card_one)
    else: 
        c1_val = 11
    
    if (card_two is not "A") or (card_two in card_numbers):
        c2_val = value_of_card(card_two)
    else: 
        c2_val = 11
    
    return c1_val + c2_val == 21
